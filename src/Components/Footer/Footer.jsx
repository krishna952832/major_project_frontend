...
const Footer = () => {
  ...
  const sendMessage = () => {
    window.location = `https://wa.me/8077071536?text=${message}`;
  };
  return (
    <>
      <footer>
        <section className="footer">
          <div className="box-container">
            <div className="box">
              ...
              <div className="share">
                <Link>
                  <i
                    onClick={() => {
                      window.location = `https://wa.me/8077071536?text=Say Hello..!!`;
                    }}
                  >
                    {<IoLogoWhatsapp />}
                  </i>
            ...
            <div className="box">
              ...
              <a href="mailto:kartiksinghgaawr@gmail.com" className="links">
                <i>
          ...
          <div className="credit">
            Created By <span>Major Project Team </span> | All Right Reserved
          </div>
        </section>
      </footer>
    </>
